...
# $Header: /var/cvsroot/gentoo-x86/net-libs/rb_libtorrent/rb_libtorrent-0.16.11.ebuild,v 1.1 2013/09/08 10:25:08 hwoarang Exp $
...
src_configure() {
	...
	if has_version '>=dev-libs/boost-1.52.0-r1'; then
		myconf+=" --with-boost-system=boost_system \
